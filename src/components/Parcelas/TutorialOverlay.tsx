...
export default function TutorialOverlay({ visible, onClose, onComplete }: TutorialOverlayProps) {
  ...
  const steps: TutorialStep[] = [
    {
      title: "¡Bienvenido!",
      description: "Aprende a crear parcelas fácilmente dibujando el polígono sobre el mapa.",
      icon: "hand-right",
      position: { x: width / 2, y: height / 2 },
    },
    {
      title: "Dibujar Polígono",
      description: "Presiona sobre el mapa para colocar los vértices de tu parcela. Cada toque añade un punto.",
      icon: "trail-sign",
      position: { x: width / 2, y: height - 150 },
    },
    {
      title: "Visualización en Tiempo Real",
      description: "El polígono se irá formando automáticamente mientras añades puntos en el mapa.",
      icon: "map",
      position: { x: width / 2, y: height / 3 },
    },
    {
      title: "Cálculo Automático",
      description: "El área y el perímetro se calculan en tiempo real a medida que dibujas.",
      icon: "calculator",
      position: { x: width / 2, y: height - 200 },
    },
    {
      title: "¡Listo para Empezar!",
      description: "Cuando termines, ingresa un nombre y guarda tu parcela.",
...
const styles = StyleSheet.create({
  ...
  stepCounter: { color: "white", fontSize: 14, fontWeight: "600" },
  cardContent: { padding: 24 },
  tutorialTitle: { fontSize: 24, fontWeight: "700", color: "#1f2937", marginBottom: 8 },
  tutorialDescription: { fontSize: 16, color: "#6b7280", lineHeight: 24, marginBottom: 24 },
  progressContainer: { flexDirection: "row", justifyContent: "center", marginBottom: 24, gap: 8 },
  ...
  skipButtonText: { color: "#6b7280", fontSize: 16, fontWeight: "500" },
  navigationButtons: { flexDirection: "row", alignItems: "center", gap: 12 },
  navButton: {
    width: 40,
    height: 40,
    borderRadius: 20,
